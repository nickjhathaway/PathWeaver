/*
 * KmerPathwayGraph_increaseKCountsAdjust.cpp
 *
...
void KmerPathwayGraph::increaseKCountsAdjust(const std::string & seq,
...
void KmerPathwayGraph::threadThroughSequenceAdjust(const PairedRead & pseq,
...
std::unordered_map<std::string, uint32_t> KmerPathwayGraph::threadThroughSequenceAdjustMate(const PairedRead & pseq,
		const std::vector<StartEndPos> & processedPositions,
...
std::unordered_map<std::string, uint32_t> KmerPathwayGraph::threadThroughSequenceAdjust(const seqInfo & seq,
		const std::vector<StartEndPos> & processedPositions,

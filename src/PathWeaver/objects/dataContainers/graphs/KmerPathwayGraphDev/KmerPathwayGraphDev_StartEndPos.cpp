/*
 * KmerPathwayGraphDev_StartEndPos.cpp
 *
...
KmerPathwayGraphDev::StartEndPos::StartEndPos(uint32_t start, uint32_t end) :
...
uint32_t KmerPathwayGraphDev::StartEndPos::len() const {
	return end_ - start_;
}

std::vector<KmerPathwayGraphDev::StartEndPos> KmerPathwayGraphDev::StartEndPos::merge(
